...
const techGroups = [
  {
    ...
    items: [
      ...
      { name: 'Rust', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rust/rust-original.svg', docs: '' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chakra UI', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/chakraui/chakraui-original.svg', docs: 'https://angular.io/docs' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'debian', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/debian/debian-original.svg', docs: 'https://www.jenkins.io/doc/' },
